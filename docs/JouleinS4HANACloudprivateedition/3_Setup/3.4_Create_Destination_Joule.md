## Configure Design-Time, Runtime, SSO Destinations in SAP BTP Cockpit
...
|------------------|---------------------|
| **Name**         | Recommended: Use `<SID><CLIENT>` and add the suffix `dt` to the name.. |
| **Type**         | `HTTP` |
...
| Property                | Value / Description |
|-------------------------|---------------------|
| **Name**                | We recommend using `<SID><CLIENT>` and add the suffix `rt` to the name. |
| **Type**                | `HTTP` |
